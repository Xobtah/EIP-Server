...
router.post('/edit/info', mid.token, mid.optionalFields([ 'username', 'email', 'firstName', 'lastName', 'birthDate', 'password', 'bio', 'coverPic', 'profilePic', 'roles', 'sportHall', 'goal' ]), (req, res) => {
...
router.post('/register', mid.fields([ 'username', 'email', 'firstName', 'lastName', 'birthDate', 'password' ]), mid.optionalFields([ 'bio', 'coverPic', 'profilePic', 'roles', 'sportHall', 'goal' ]), (req, res) => {
    console.log('reg');
    let user = new User();
    for (key in req.fields)
        user[key] = req.fields[key];
